...
Harness 0.4.6+ owns MCP discovery and policy classification; Harness 0.4.8 is the current verified baseline. The gateway proxies only the non-executing foundation routes:
