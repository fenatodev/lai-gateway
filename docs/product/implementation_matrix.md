...
| document_text_local | experimental | leitura local restrita | CLI/API/UI restritos | [módulo](../../lai_gateway/document_text.py), [testes](../../tests/test_document_text.py), [spec](pr_98_restricted_document_text.md) | Somente `.txt/.md/.json` em workspace explícito; sem PDF/OCR/Office/HOME scan/rede/write; conteúdo não confiável | PR99 Workbench para documentos |
| document/media | contract | metadados/contrato | Metadados | [registry](../../lai_gateway/adapters.py), [testes](../../tests/test_adapters.py) | Adapter amplo permanece contrato; mídia, OCR, upload e ingestão completa seguem bloqueados | PR99 Workbench para documentos; mídia adiada |
