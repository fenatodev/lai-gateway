...
- **spec de PR / atual** — [PR118](pr_118_model_runtime_profile.md): perfil UX read-only do modelo local sem baixar/iniciar runtime, probe automático, grants ou execução.
