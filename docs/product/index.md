...
- **spec de PR / atual** — [PR119](pr_119_public_browser_v2.md): source inspector público restrito sem browser autenticado, cookies, JS, formulários, downloads ou link-following.
