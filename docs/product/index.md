...
- **spec de PR / atual** — [PR108](pr_108_n8n_minimal_governed.md): n8n mínimo governado como plano local por digest, grant single-use e sem execução real de workflow.
